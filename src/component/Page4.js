...
export default function Page4() {
    const imageURL4 = "https://thumbs.dreamstime.com/b/panoramic-view-watzmann-east-face-panoramic-view-watzmann-east-face-beautiful-sunny-day-summer-berchtesgadener-land-194094273.jpg"
    ...
    return (
        ...
        <div
            ...
            style={{
                backgroundImage: `url(${imageURL4})`, height: "1000px", width: "100%"
            }}>
            <div class="flex h-25 items-center justify-center">
                <div class="text-black">
                    <div className="p-4 pr-6   space-y-2">
                        <h2 className="text-lg font-semibold leading-8 text-3xl not-italic font-bold gap-24">Review from customers</h2>
            ...
            <div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12">
                <div class="mb-12 md:mb-0">
                    ...
                    <h5 class="mb-4 text-xl font-semibold">Lolla Smith</h5>
